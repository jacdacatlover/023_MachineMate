...
export default function MachineDetailScreen() {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {/* Muscle diagram */}
      {machine.muscleDiagramImage && (
        <View style={styles.diagramContainer}>
          <Text variant="titleSmall" style={styles.diagramTitle}>
            Muscles Worked
          </Text>
          <Image source={{ uri: machine.muscleDiagramImage }} style={styles.diagram} />
        </View>
      )}

      {/* Muscle animation */}
      {machine.muscleAnimationVideo && (
        <View style={styles.animationContainer}>
          <Text variant="titleSmall" style={styles.animationTitle}>
            Animation
          </Text>
          <Image source={{ uri: machine.muscleAnimationVideo }} style={styles.animation} />
        </View>
      )}
