...
> **Status:** Completed during the feature-refactor effort. Retained here as an archive so we can reference the reasoning behind the current structure. For new work, use `plan/next.md` and `plan/detailplan.md`.
